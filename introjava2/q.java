            ...
            case 1:
                ...
                switch (acc) {
                    case 1:
                        ...
                        b = f.getBytes();
                        try {
                            FileOutputStream fout = new FileOutputStream("/home/sugardaddy/Desktop/momo/introjava2/sbiLogs.txt");
                            fout.write(b);
                            fout.close();
                        } catch (Exception e) {
                            e.printStackTrace();
                    ...
                    case 2:
                        ...
                        b = f.getBytes();
                        try {
                            FileOutputStream fout = new FileOutputStream("/home/sugardaddy/Desktop/momo/introjava2/boiLogs.txt");
                            fout.write(b);
                            fout.close();
                        } catch (Exception e) {
                            e.printStackTrace();
                    ...
                    case 3:
                        ...
                        b = f.getBytes();
                        try {
                            FileOutputStream fout = new FileOutputStream("/home/sugardaddy/Desktop/momo/introjava2/iciciLogs.txt");
                            fout.write(b);
                            fout.close();
                        } catch (Exception e) {
                            e.printStackTrace();
